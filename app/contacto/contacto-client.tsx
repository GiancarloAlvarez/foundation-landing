...
import { MapPin, Phone, Mail, Clock, Facebook, Instagram, Twitter, Youtube, Send, CheckCircle, MapPinned } from 'lucide-react';
          ...
          <div>
            <div className="bg-fumablac-blue rounded-2xl p-8 text-white mb-6">
              ...
              <div className="flex gap-3 mt-8">
                {[Facebook, Instagram, Twitter, Youtube]?.map((IconComp: any, i: number) => (
